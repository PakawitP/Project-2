...
import { StyleSheet, Text, View ,Alert,Image,Modal, TouchableHighlight,ScrollView } from 'react-native';
...
export default function History (props) {
  ...
  const SaveData = (name,contact,UrlPhoto)=>{
    docRef.set({
      Name: name,
      Contact: contact,
      Photo: UrlPhoto,
 ...
 if(Data != null){
  return (
    ...
    <ScrollView>
      ...
      { <Image source={{ uri: image }} style={{ width: 200, height: 250 ,margin: 15,borderWidth: 1,borderColor: '#CA7004'}} />}
        <Modal
          animationType="slide"
          transparent={true}
